...
<div class="overview-grid">
  <a class="overview-card" href="puremdx-master-architecture-vision-repository/"><strong>PureMDX Architecture</strong><span>Master blueprint of the medical knowledge ecosystem and ingestion pipeline.</span></a>
